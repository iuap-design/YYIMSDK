...
//最大化按钮点击
(0, _jquery2.default)('.scalechat').click(function () {
...
//关闭窗口按钮点击
(0, _jquery2.default)('.closechat').click(function () {
    localStorage.clear();
...
//搜索好友
(0, _jquery2.default)('.yyim-search').on('keydown', function (e) {
    var keyword = (0, _jquery2.default)(this).val();
...
_jqelements.$hcontacts.on('click', 'li', function () {
    ...
    localStorage.setItem('targetuserid', (0, _jquery2.default)(this).attr('data-id')); //保存聊天对方id，用于发送消息
    (0, _getHistoryMessage2.default)((0, _jquery2.default)(this).attr('data-sessionVersion'), (0, _jquery2.default)(this).attr('data-id'), (0, _jquery2.default)(this).attr('data-type'));
});
...
//表情按钮点击
(0, _jquery2.default)('.j_menu_bq').hover(function () {
    (0, _jquery2.default)(this).addClass('hover');
    (0, _jquery2.default)('.bq_tip').css('display', 'block');
}, function () {
    (0, _jquery2.default)(this).removeClass('hover');
    (0, _jquery2.default)('.bq_tip').css('display', 'none');
}).click(function () {
...
_jqelements.$j_bq_box.on('click', 'li', function () {
    _jqelements.$yyim_editor.val(_jqelements.$yyim_editor.val() + (0, _jquery2.default)(this).attr('data-code'));
...
//图片按钮点击
(0, _jquery2.default)('.j_menu_tp').hover(function () {
    (0, _jquery2.default)(this).addClass('hover');
    (0, _jquery2.default)('.tp_tip').css('display', 'block');
}, function () {
    (0, _jquery2.default)(this).removeClass('hover');
    (0, _jquery2.default)('.tp_tip').css('display', 'none');
}).click(function () {
    (0, _jquery2.default)('#uploadfile').click();
});
...
//文件按钮点击
(0, _jquery2.default)('.j_menu_wj').hover(function () {
    (0, _jquery2.default)(this).addClass('hover');
    (0, _jquery2.default)('.wj_tip').css('display', 'block');
}, function () {
    (0, _jquery2.default)(this).removeClass('hover');
    (0, _jquery2.default)('.wj_tip').css('display', 'none');
}).click(function () {
    console.log('发送文件');
});
...
exports.$chats_list = exports.$chat_box = exports.$btn_send = exports.$yyim_editor = exports.$j_bq_box = exports.$yyim_box = exports.$hcontacts = exports.$j_move = exports.$yyim_main = exports.$login_btn = exports.$login_username = exports.$yyim_iogin = undefined;
...
var $yyim_iogin = exports.$yyim_iogin = (0, _jquery2.default)('.yyim-iogin'); //登陆框
var $login_username = exports.$login_username = (0, _jquery2.default)('.login-username'); //登陆用户名
var $login_btn = exports.$login_btn = (0, _jquery2.default)('.login-btn'); //登陆按钮
var $yyim_main = exports.$yyim_main = (0, _jquery2.default)('.yyim-main'); //聊天最外层窗口
var $j_move = exports.$j_move = (0, _jquery2.default)('.j_move'); //聊天窗口头
var $hcontacts = exports.$hcontacts = (0, _jquery2.default)('.hcontacts'); //最近联系人框
var $yyim_box = exports.$yyim_box = (0, _jquery2.default)('.yyim-box'); //聊天框
var $j_bq_box = exports.$j_bq_box = (0, _jquery2.default)('.j_bq_box'); //表情盒子
var $yyim_editor = exports.$yyim_editor = (0, _jquery2.default)('.yyim-editor'); //聊天输入框
var $btn_send = exports.$btn_send = (0, _jquery2.default)('.adit-btn-send'); //发送按钮
var $chat_box = exports.$chat_box = (0, _jquery2.default)('.chat-box'); //控制是否具有聊天内容
var $chats_list = exports.$chats_list = (0, _jquery2.default)('.chats-list'); //聊天信息列表
