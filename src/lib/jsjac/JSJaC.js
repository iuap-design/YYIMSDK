...
var JSJaC = {
	...
	require : function(libraryName) {
		...
		jQuery("head").append(
				'<script type="text/javascript" src="' + libraryName
						+ '"></script>');
	},
	load : function() {
		var includes = [ 'xmlextras', 'jsextras', 'crypt', 'JSJaCConfig',
				'JSJaCConstants', 'JSJaCCookie', 'JSJaCJSON', 'JSJaCDebugger',
				'JSJaCJID', 'JSJaCUtils', 'JSJaCBuilder', 'JSJaCPacket',
				'JSJaCError', 'JSJaCKeys', 'JSJaCConnection',
				'JSJaCHttpPollingConnection', 'JSJaCHttpBindingConnection',
				'JSJaCConsoleLogger', 'JSJaCWebSocketConnection' ];
